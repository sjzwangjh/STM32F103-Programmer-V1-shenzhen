...
/* ----------Statistics EEPROM Start Address---------- */
#define HW_HANDLER_STATISTICS_EEPROM_START_ADDR  0x0500UL
#define HW_HANDLER_STATISTICS_EEPROM_END_ADDR    0x1FFFUL
#define HW_HANDLER_STATISTICS_RECORD_SIZE        32U
#define HW_HANDLER_STATISTICS_RECORD_COUNT       ((HW_HANDLER_STATISTICS_EEPROM_END_ADDR - HW_HANDLER_STATISTICS_EEPROM_START_ADDR + 1UL) / HW_HANDLER_STATISTICS_RECORD_SIZE)
#define HW_HANDLER_STATISTICS_SAVE_INTERVAL      5U
